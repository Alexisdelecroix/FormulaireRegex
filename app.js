...
let myForm = document.getElementById("validations");
...
myForm.addEventListener('submit', function(e) {
    ...
    let myDate = document.getElementById("naissance");
    ...
    if (myPrenom.value.trim() == "") {
        let myError1 = document.getElementById('errorPrenom');
        myError1.innerHTML = "Le champs est requis";
        myError1.style.color = 'red';
        e.preventDefault();
    } else if (myRegex.test(myPrenom.value) == false) {
        let myError1 = document.getElementById('errorPrenom');
        myError1.innerHTML = "Le nom doit comporter des lettres, des tirets uniquements.";
        myError1.style.color = 'red';
        e.preventDefault();
    }
